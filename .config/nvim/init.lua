...
map({ 'n' }, '<Leader>s', fzf.git_status,                                { silent = true, noremap = true, desc = "Fuzzy git status"})
...
map({ 'n' }, '<leader>i', "<cmd>Trouble lsp_incoming_calls toggle<cr>",  { silent = true, noremap = true, desc = "Incoming calls (Trouble)" })
...
-- dap mappings
map('n', '<F5>', function() require('dap').continue() end, {desc = "DAP launch/continue"})
...
map('n', '<F12>', function() require('dap').step_out() end, {desc = "Debugger stop out"})
map('n', 'gb', function() require('dap').toggle_breakpoint() end, {desc = "Toggle breakpoint"})
map('n', 'gB', function() require('dap').set_breakpoint() end, {desc = "Set breakpoint"})
map('n', '<Leader>lp', function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end, {desc = "Set logpoint"})
